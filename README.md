...
- Custom function and variable names will be minified to only keep the first letter and capital letters, so for example `#WaterTemperature` will become `#WT`, `#allowDHW` will become `ADHW`.
